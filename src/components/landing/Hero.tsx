      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-12 lg:items-center lg:max-w-6xl 2xl:max-w-7xl mx-auto w-full transition-all duration-300">
        <div className="flex flex-col items-center lg:items-start">
          ...
          <p className="text-edgi-paper/70 text-lg md:text-xl text-center lg:text-left leading-relaxed mb-12 max-w-lg md:max-w-xl lg:max-w-2xl transition-all duration-300">
            ...
            <a href="/centers" className="text-edgi-green hover:underline">
          ...
          <div className="flex flex-col lg:flex-row gap-4 w-60 lg:w-md transition-all duration-300">
            <Link
              href="/tools"
              className="bg-edgi-green text-edgi-ink font-medium px-8 py-4 rounded-full text-sm border border-edgi-green hover:bg-edgi-ink hover:text-edgi-green hover:border-edgi-green transition-colors text-center w-full sm:w-auto"
            >
              Explore the Tools
            </Link>
            <a
              ...
              className="border border-edgi-paper text-edgi-paper font-medium px-8 py-4 rounded-full text-sm hover:border-edgi-green hover:text-edgi-green transition-colors text-center w-full sm:w-auto"
            >
